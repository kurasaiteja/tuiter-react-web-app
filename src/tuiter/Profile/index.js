        ...
        <>
            <div className="row">
                ...
                <div className="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-10">
                    ...
                    <span className="wd-gray-color">100 Tweets</span>
                </div>
            </div>
            <div className="row">
                <img src={process.env.PUBLIC_URL + '/images/inspiration.jpg'} alt="..." className="img-fluid"
                     width="100%" height="200px"/>
            </div>
            <div className="row">
                <div className="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-10">
                    <img src={process.env.PUBLIC_URL + '/images/profile-pic.jpeg'} alt="..."
